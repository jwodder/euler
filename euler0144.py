#!/usr/bin/python
r"""Investigating multiple reflections of a laser beam
    ...
    The section corresponding to $-0.01\leq x\leq +0.01$ at the top is missing,
    ...
    line shows the line tangent to the ellipse at the point of incidence of the
    first bounce.
